...
bulkQuestionsData.push(...[
    ...
    { grade: 0, genre: "english", type: "which", text: "えいごで 「ハロー」と いわれたら、あいさつの おへんじをする。○か×か？", choices: ["○", "×"], answer: "○", explanation: "せいかいは ○（まる）！<br><b>Hello（ハロー）</b> は「こんにちは」だから、元気にハローとおかえししよう！" },
    ...
    { grade: 0, genre: "english", type: "which", text: "えいごで 「バイバイ」は、あさ 起（お）きたときに いう あいさつである。○か×か？", choices: ["○", "×"], answer: "×", explanation: "せいかいは ×（ばつ）！<br><b>Bye-bye（バイバイ）</b> は、おともだちと<b>「さようなら」</b>をして わかれるときの ことばだよ！" },
    ...
    { grade: 0, genre: "english", type: "which", text: "えいごで 「ミルク」といえば、白（しろ）い ぎゅうにゅう のことである。○か×か？", choices: ["○", "×"], answer: "○", explanation: "せいかいは ○（まる）！<br>朝（あさ）ごはんで のむ おいしいぎゅうにゅうは <b>Milk（ミルク）</b> というんだよ！" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "japanese", type: "which", text: "「先生が参る（まいる）」という言い方は、先生への敬語（けいご）として正しい。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>「参る」は自分がへりくだる言葉だよ。先生が来るときは<span style='color:#e74c3c; font-weight:bold;'>「お見えになる」や「来られる」</span>が正しいよ。" },
    ...
    { grade: 4, genre: "japanese", type: "which", text: "辞書（じしょ）で言葉を調べるとき、「あめ」は「あき」よりも後ろに載（の）っている。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>50音順で比べると、「あ<b>き</b>」の「き」よりも、「あ<b>め</b>」の「め」のほうが後ろにあるからだね！" },
    ...
    { grade: 4, genre: "japanese", type: "which", text: "「はな（花）」という言葉の反対の意味の言葉は「はっぱ」である。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>「はな」に反対の意味の言葉はないよ。物の名前には反対がないことが多いんだ。" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "math", type: "which", text: "「平（へい）行（こう）四辺形（しへんけい）」の向かい合う辺の長さは、それぞれ等しい。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>平（へい）行（こう）四辺形（しへんけい）は、向かい合う<b>2組の辺がどちらも平（へい）行（こう）</b>で、長さも同じになるよ！" },
    ...
    { grade: 4, genre: "math", type: "which", text: "分数（ぶんすう）の問題だよ。「5分の3」は「5分の2」よりも小さい。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>下の数が同じなら、上の数（分子（ぶんし））が<b>大きいほう（5分の3）が全体の量（りょう）も大きくなる</b>よ！" },
    ...
    { grade: 4, genre: "math", type: "which", text: "「3 ÷ 0」の答えは「0」である。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>算数では、数を<b>「0」でわることはできない</b>というルールがあるんだよ！" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "moral", type: "which", text: "友達との約束（やくそく）の時間に遅れそうになったとき、「だまって遅れていく」のが正しい。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>遅れそうだとわかった時点で、必ず相手に <b>連絡（れんらく）をして理由を伝える</b>のが、相手を大切にするマナーだよ。" },
    ...
    { grade: 4, genre: "moral", type: "which", text: "学校の備品（ボールなど）は、みんなの物なので雑（ざつ）に扱（あつか）って壊（こわ）しても気にしなくてよい。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>みんなで使う物は、次に使う人のことを考えて <b>「大切に優しく」</b> 扱うのが、立派（りっぱ）なプレイヤーのルールだよ。" },
    ...
    { grade: 4, genre: "moral", type: "which", text: "生き物を飼（か）うときは、途中で飽（あ）きてしまったらどこかに捨て（す）ててもよい。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>生き物には大切な命（いのち）があるよ。<b>最（さい）期（ご）まで飼（か）いきる</b>のが、飼うときの大事な約束だよ！" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "science", type: "which", text: "月は太陽と同じように、東からのぼって西へ沈（しず）む。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>地球が自転（じてん）しているため、<b>太陽も月も星も</b>、すべて東から西へ動いて見えるんだよ。" },
    ...
    { grade: 4, genre: "science", type: "which", text: "空気は温められると、体積（たいせき）（空気の広さ）が大きくなる。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>空気や水は<b>温められると大きく広がり（体積が大きくなる）</b>、冷やされると小さくなるよ。" },
    ...
    { grade: 4, genre: "science", type: "which", text: "日かげの地面（じめん）は、日なたの地面よりも温度（おんど）が高い。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>太陽の光が直接（ちょくせつ）あたる<b>日なたのほうが、地面が温められて温度（おんど）が高くなる</b>よ。" },
    ...
    { grade: 4, genre: "science", type: "which", text: "雨がふったあと、運動場（うんどうじょう）の水がなくなったのは、すべて土にしみこんだからである。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>土にしみこむだけでなく、水が<b>空気中に蒸（じょう）発（はつ）して水蒸気になった</b>からでもあるよ。" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "social", type: "which", text: "災害（さいがい）の危険（きけん）がある場所を予測（よそく）した「ハザードマップ」を見ることで、避（ひ）難（なん）場所が確認（かくにん）できる。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>自分の住んでいる地域のハザードマップを事前に確（かく）認（にん）しておくことが、安全（あんぜん）のために大切だよ。" },
    ...
    { grade: 4, genre: "social", type: "which", text: "警察（けいさつ）署（しょ）で働くおまわりさんは、火事（かじ）が起きたときに火を消すのが一番の仕事である。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br>火を消すのは<b>消防署（しょうぼうしょ）の仕事</b>だよ。おまわりさんは、街のパトロールや事件（じけん）を防ぐのが仕事だよ。" },
    ...
    { grade: 4, genre: "social", type: "which", text: "都道府県（とどうふけん）の中で、まわりがすべて海に囲ま（かこま）れている島国のような県は「沖縄（おきなわ）県」である。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>日本の南にある<b>沖縄県は、たくさんの美しい島が集まってできている県</b>なんだよ。" },
    ...
    { grade: 4, genre: "social", type: "which", text: "ゴミを減らすための「3R（スリーアール）」で、いらない物を「断る（ことわる）」ことをリデュースという。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br>ゴミそのものを<b>最初（さいしょ）から出さないように減らす（Reduce）</b>という、とても大切な考え方だよ。" },
...
bulkQuestionsData.push(...[
    ...
    { grade: 4, genre: "english", type: "which", text: "英語のあいさつ「Good morning」は、夜（よる）ねる前に使う言葉である。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br><b>Good morning（グッドモーニング）</b> は「おはよう」という、<b>朝（あさ）一番に使う言葉</b>だよ。" },
    ...
    { grade: 4, genre: "english", type: "which", text: "英語で別れ（わかれ）のあいさつをするときは「Goodbye」という。○か×か？", choices: ["○", "×"], answer: "○", explanation: "正解は ○（まる）！<br><b>Goodbye（グッドバイ）</b> や「See you」と言うと、<b>「さようなら、またね」</b>という意味（いみ）になるよ！" },
    ...
    { grade: 4, genre: "english", type: "which", text: "英語の「milk」は、くだものの「ぶどうジュース」のことである。○か×か？", choices: ["○", "×"], answer: "×", explanation: "正解は ×（バツ）！<br><b>milk（ミルク）</b> は、みんなが給食（きゅうしょく）などで毎日飲む白い<b>「牛乳（ぎゅうにゅう）」</b>のことだよ！" },
